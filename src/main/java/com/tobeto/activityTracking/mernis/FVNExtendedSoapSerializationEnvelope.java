...
class FVNSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class FVNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(FVNDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new FVNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static FVNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static FVNDateTimeConverter dateTimeConverter = new FVNStandardDateTimeConverter();

    public FVNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FVNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FVNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FVNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FVNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FVNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
