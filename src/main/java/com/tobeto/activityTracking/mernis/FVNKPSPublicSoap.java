...
public class FVNKPSPublicSoap
{
    ...
    public FVNKPSPublicSoap(){}

    public FVNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FVNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FVNExtendedSoapSerializationEnvelope envelope= new FVNExtendedSoapSerializationEnvelope(FVNExtendedSoapSerializationEnvelope.VER11);
